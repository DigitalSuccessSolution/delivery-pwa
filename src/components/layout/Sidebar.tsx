      ...
      >
        {!isCollapsed && (
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-[#A5D8FF]/30 text-[#1E4E70] flex items-center justify-center shadow-xs border border-[#A5D8FF]">
              <HeartPulse className="w-5 h-5 text-[#1E4E70]" />
            </div>
            <div>
              <h2 className="font-semibold text-[#1E4E70] text-[13px] leading-none tracking-tight">
                MONCRADEL
              </h2>

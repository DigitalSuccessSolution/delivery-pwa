...
export default function SupportPage() {
  ...
  return (
    <>
      <div className="animate-fade-in-up pb-24 font-sans max-w-5xl mx-auto w-full space-y-6 pt-2">



        {/* Desktop Page Header */}
        <div className="hidden md:flex flex-col mb-4 px-1">
          <h1 className="text-2xl md:text-3xl font-medium text-gray-900">Help & Support</h1>
